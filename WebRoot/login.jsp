...
<html>
  ...
  <body>
    ...
    <div class="login_bg">
    	<div class="form">
    	<span class="login_txt_bt">登陆博客系统</span>
    	<form action="/zylBlog/userServlet" method="post">
            ...
            <table >
				...
				<tr>
 				...
 				<tr>
                    <td></td>
                    <td><input type="submit" value="登 陆"><input type="reset" value="取 消" class="login_botton"></td>
                </tr>
                <tr>
                    <td></td>
                    <td>还没有账号？<a href="regist.jsp">立即注册</a></td>
                </tr>
             </table><br>
